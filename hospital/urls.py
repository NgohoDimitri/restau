...
from hospital.views import DetailsBillsIngredientViewSet, DetailsInventoryViewSet, DetailsPatientAccountViewSet, DetailsStock_movementViewSet, MovementStockViewSet, PatientAccountViewSet, DistrictViewSet, SeasonViewSet, Stock_movementViewSet, StockViewSet, Storage_depotsViewSet, Type_patientViewSet, UserViewSet, HospitalViewSet, home_view, \
    ...
    PatientSettlementViewSet, InventoryViewSet, \
     RegionViewSet, CityViewSet, user_logout, LoginView, \
